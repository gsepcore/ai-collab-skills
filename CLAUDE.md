...
8. Keep live observability updated in `.ai-collab/live/claude-code.agent.json` before and after meaningful work: commands, tests, file edits, blockers, and handoffs.
9. After every response, create or update your session log at `.ai-collab/claude-code-{YYYYMMDD-HHMMSS}.md`.
