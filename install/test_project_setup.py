...
class TestProjectSetup(unittest.TestCase):
    ...
    def test_onboards_agents_with_container_and_models(self):
        ...
        self.assertIn("ai-collab-turn.py preflight", capabilities["automation_policy"]["turn_preflight"])
    ...
    def test_shared_agents_md_can_hold_multiple_agent_snippets(self):
        ...
        self.assertIn("Always-on activation contract:", agents_md)
    ...
    def test_opencode_gets_agent_specific_rules_file(self):
        ...
        self.assertIn("Always-on activation contract:", rules)
        self.assertIn("ai-collab-turn.py preflight", rules)
        self.assertIn("Context fallback only when the always-on helper is missing", rules)
