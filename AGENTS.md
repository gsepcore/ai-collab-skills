...
6. Read the latest session logs in `.ai-collab/*.md` from other agents, skipping `PROTOCOL.md`, `CONTEXT.md`, `TEAM.md`, inbox files, and your own current-session log. Respect every `Do Not Touch (Avoid Conflicts)` section before analyzing, replying, or editing.
7. If `.ai-collab/live/summary.json` exists, read it for current agent phases, dirty files, alerts, and open conversations before making coordination decisions.
8. Keep live observability updated in `.ai-collab/live/codex.agent.json` before and after meaningful work: commands, tests, file edits, blockers, and handoffs.
9. After every response, create or update your session log at `.ai-collab/codex-{YYYYMMDD-HHMMSS}.md`.
...
6. Read the latest session logs in `.ai-collab/*.md` from other agents, skipping `PROTOCOL.md`, `CONTEXT.md`, `TEAM.md`, inbox files, and your own current-session log. Respect every `Do Not Touch (Avoid Conflicts)` section before analyzing, replying, or editing.
7. If `.ai-collab/live/summary.json` exists, read it for current agent phases, dirty files, alerts, and open conversations before making coordination decisions.
8. Keep live observability updated in `.ai-collab/live/hermes.agent.json` before and after meaningful work: commands, tests, file edits, blockers, and handoffs.
9. After every response, create or update your session log at `.ai-collab/hermes-{YYYYMMDD-HHMMSS}.md`.
